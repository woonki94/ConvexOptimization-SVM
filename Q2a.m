...
%Set d
d_sep =1;
d_ov = computeOptimalD(train_ov, test_ov,d_values,'proj' );


[u_sep,v_sep,obj_sep,time_measure_sep] = projectedGradient(train_sep,d_sep,max_iter);
[u_ov, v_ov,obj_ov,time_measure_ov] = projectedGradient(train_ov,d_ov,max_iter);
