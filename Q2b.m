...
%Set d
d_sep =1;
d_ov = computeOptimalD(train_ov, test_ov, d_values, 'nesterov' );


[u_sep,v_sep,obj_sep] = projectedNesterov(train_sep,d_sep,max_iter);
[u_ov, v_ov,obj_ov] = projectedNesterov(train_ov,d_ov,max_iter);
